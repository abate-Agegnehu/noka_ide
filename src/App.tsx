      ...
      <header className="h-12 border-b border-white/5 flex items-center justify-between px-4 bg-slate-950 z-50">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight">Nova<span className="text-blue-500">IDE</span></span>
          </div>
          ...
          <div className="flex items-center gap-1 text-xs text-slate-400">
                ...
                {isFileMenuOpen && (
                  ...
                  >
                    <button 
                      ...
                      onClick={() => { createFile('new-file.js', firstRoot?.id || null); setIsFileMenuOpen(false); }}
                    >
                    ...
                    <button 
                      className="w-full text-left px-3 py-2 hover:bg-white/5 flex items-center gap-2 transition-colors"
                      onClick={() => { createFolder('new-folder', firstRoot?.id || null); setIsFileMenuOpen(false); }}
                    >
            ...
            <span className="hover:text-slate-200 cursor-pointer transition-colors px-2 py-1">Edit</span>
            <span className="mx-1 opacity-20">/</span>
            <span className="hover:text-slate-200 cursor-pointer transition-colors px-2 py-1">View</span>
            <span className="mx-1 opacity-20">/</span>
            <span className="hover:text-slate-200 cursor-pointer transition-colors px-2 py-1">Go</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button className="p-2 hover:bg-white/5 rounded-lg text-slate-400 transition-colors" title="Search">
            <Search size={18} />
          </button>
          <button className="p-2 hover:bg-white/5 rounded-lg text-slate-400 transition-colors" title="Settings">
            <Settings size={18} />
          </button>
          ...
          <button className="p-2 hover:bg-white/5 rounded-lg text-slate-400 transition-colors" title="Share">
            <Share2 size={18} />
          </button>
        </div>
      </header>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-12 border-r border-white/5 flex flex-col items-center py-4 gap-4 bg-slate-950">
          ...
          <button 
            className={cn(
              "p-2 transition-colors",
              isTerminalOpen ? "text-blue-400 bg-blue-500/10 rounded-lg" : "text-slate-500 hover:text-slate-300"
            )} 
          ...
          <button 
            className={cn(
              ...
              isChatOpen ? "text-blue-400 bg-blue-500/10 rounded-lg" : "text-slate-500 hover:text-slate-300"
            )} 
            onClick={toggleChat}
            title="AI Assistant"
          >
